...
import com.example.quanlysach_demo.Database.Profile;
import com.example.quanlysach_demo.Database.UserViewModel;
import com.example.quanlysach_demo.models.UserDetailModel;
import com.example.quanlysach_demo.util.PreferencesService;
...
//            databaseHelper.addUserDetailModel(userDetailModel);
         ...
         Profile p = mUserViewModel.getCurrProfile();
