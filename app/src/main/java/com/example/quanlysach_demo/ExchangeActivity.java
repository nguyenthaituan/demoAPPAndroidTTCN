...
import com.example.quanlysach_demo.Database.User;
...
public class ExchangeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(mUserViewModel.getBook(mOwnerBookId).getBookPic()).into(mLeftBookView);
        ...
        Picasso.get().load(mUserViewModel.getBook(mOtherOwnerBookId).getBookPic()).into(mRightBookView);
